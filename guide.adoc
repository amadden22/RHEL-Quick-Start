...
== Install RHEL
With our installation file downloaded  . 

*_Press enter to begin the installation_*

image:Picture6.png[500,500]
{sp} + 

*_Choose a language and click continue_*

image:Picture7.png[500,500]
{sp} + 
...
image:Picture8.png[500,500]
{sp} + 

Make sure to enter a root password and create a user for your system, while the installation is loading. 
image:Picture9.png[500,500]
{sp} + 
